...
import static com.jkdesigns.stsproject.transactions.datei;
...
public class MyAdapterTrans extends RecyclerView.Adapter<MyViewHolderTrans> implements Filterable {
    ...
    public void onBindViewHolder(final MyViewHolderTrans holder, @SuppressLint("RecyclerView") final int position) {
        ...
        db = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("Invoice").child(datei).child("Bill")
                .child(models.get(position).getKey());
        dbp = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("invoices").child(datei).child(models.get(position).getKey());
        db.keepSynced(true);
                    ...
                    public void onDataChange(final DataSnapshot dataSnapshot) {
                        ...
                        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //get count
                                dut = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("tables").child("Invoice");
                                ...
                                //update count
                                dut.getParent().child("Invoice").child("count").addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {

                                        dut.getParent().child("Invoice").child("count")
