...
public class PrinterCommands {
    public static final byte HT = 0x9; //The storage control block address is invalid
    public static final byte LF = 0x0A; //moves the cursor down to the next line without returning to the beginning of the line
    public static final byte CR = 0x0D; //return to the beginning of the current line without advancing downward
    public static final byte ESC = 0x1B; //ASCII code for. Escape
    public static final byte DLE = 0x10; //"one zero", which converts to a decimal 16 (sixteen)
