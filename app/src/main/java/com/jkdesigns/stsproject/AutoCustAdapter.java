...
public class AutoCustAdapter extends ArrayAdapter<Modelcustomer> {
    ...
    String custkey = "", amt = "", custname = "", custaddr = "", p13 = "", p12 = "";
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (model != null) {
            ...
            if (item != null)
                ...
                item.setText(model.getP03() + "-" + model.getP15() + '\n' +"( Credit: " + model.getP14() + " )");
        }
        return view;
    }
    ...
    Filter nameFilter = new Filter() {
        ...
        public CharSequence convertResultToString(Object resultValue) {
            String str = ((Modelcustomer) resultValue).getP03();
            ...
            p13 = ((Modelcustomer) resultValue).getP13();
    ...
    public String[] detcust() {
        String[] str = { custkey, amt, custname, custaddr, p13, p12 };
        return str;
    }
}
