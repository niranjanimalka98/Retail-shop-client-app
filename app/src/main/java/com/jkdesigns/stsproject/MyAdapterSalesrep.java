...
public class MyAdapterSalesrep extends RecyclerView.Adapter<MyViewHolderCustomer> implements Filterable {
    ...
    CustomFilterSalesrep filter;

    public MyAdapterSalesrep(Context c, ArrayList<Modelcustomer> models) {
    ...
    public MyViewHolderCustomer onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(c).inflate(R.layout.salesrepcard, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolderCustomer holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.date.setText(models.get(position).getP13());
        holder.money.setText(models.get(position).getP14());
        holder.b3.setText(models.get(position).getP15());
        holder.phone.setText(models.get(position).getP12());
        ...
        holder.editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(c, UpdateSalesrep.class);
        ...
        holder.log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(c, SalesrepLog.class);
        ...
        holder.delbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("SalesRep")
                        .child("Person").child(models.get(position).getKey());
                dbp = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("salesreps").child(models.get(position).getKey());
                db.keepSynced(true);
                    ...
                    public void onDataChange(final DataSnapshot dataSnapshot) {
                        ...
                        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //update count
                                dut.getParent().child("SalesRep").child("count").addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {

                                        dut.getParent().child("SalesRep").child("count")
                        ...
                        alert.setPositiveButton("Update", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if (!value.toString().trim().isEmpty()) {
                                    ...
                                    BigDecimal due = BigDecimal.valueOf(Double.parseDouble(map.get("p14"))).add(a);
    ...
    public Filter getFilter() {
        ...
        if (filter == null) {
            filter = new CustomFilterSalesrep(filterList, this);
        }
        return filter;
    }
}
