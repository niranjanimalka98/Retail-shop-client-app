...
public class transactions extends Fragment implements SearchView.OnQueryTextListener, View.OnClickListener {
    View v;
    ...
    public void onResume() {
        ...
        db = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("Invoice").child(datei);
        db.keepSynced(true);
