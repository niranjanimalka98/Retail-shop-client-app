...
public class salesreps extends Fragment implements SearchView.OnQueryTextListener {
    View v;
    String uid;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        getActivity().setTitle("Sales Reps");
        MainActivity.flag = 1;
    ...
    public void onResume() {
        ...
        MainActivity.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getContext(), NewSalesrep.class);
                startActivity(i);
            }
        });
        MainActivity.fab.show();
        // ADAPTER
        adapter = new MyAdapterSalesrep(getContext(), retrieve());
