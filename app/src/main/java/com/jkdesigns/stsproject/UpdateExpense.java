...
public class UpdateExpense extends AppCompatActivity implements View.OnClickListener {
    ...
    private DatabaseReference du,dup,dbs;
    String s;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        du = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("Expense").child("E")
                .child(s);
        ...
        if (id == R.id.del) {
            ...
            du.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(final DataSnapshot dataSnapshot) {
                    ...
                    AlertDialog.Builder alert = new AlertDialog.Builder(UpdateExpense.this);
    ...
    public void updateInfo(View view) {
        ...
        if (validate()) {
            ...
            final String padd = "[{\"name\":\"p03\",\"value\":\""+sName+"\"}," +
                    ...
                    "{\"name\":\"key\",\"value\":\""+s+"\"}," +
                    "{\"name\":\"log\",\"value\":\""+"[" + format.format(calendar.getTime()) + "] " + "Expense "+sName+" updated. Amount:" + sbalance+"\"}]";

            // add to customers
            dup = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("expenses");
            dup.getParent().child("expenses").child(s).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {

                    dup.getParent().child("expenses").child(s)
                            .setValue(padd);
            ...
            du.child("log").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    du.child("log").setValue(value + "[" + format.format(calendar.getTime()) + "] "
                            + "Expense updated. Amount :" + sbalance + "\n");
                }
                            ...
                            if (format.format(calendar.getTime()).equals(date)) {
                                ...
                                du.getParent().getParent().getParent().child("Log").child("log")
                                        .setValue(format.format(calendar.getTime()) + "\n["
                                                + fm.format(calendar.getTime()) + "] " + item + " Expense Updated\n"
                                                + l);
                            } else {
                                du.getParent().getParent().getParent().child("Log").child("log")
                                        .setValue(format.format(calendar.getTime()) + "\n["
        ...
        //month money
        dbs.child("m").child(monthformat.format(csummary.getTime())).child("e-"+s).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.hasChild("z04")) {
                    ...
                    //dbs.child("m").child(monthformat.format(csummary.getTime())).child("e-"+s).child("z03").setValue("ex");//tag
                    dbs.child("m").child(monthformat.format(csummary.getTime())).child("e-"+s).child("z04").setValue(sName);//expense
                    dbs.child("m").child(monthformat.format(csummary.getTime())).child("e-"+s).child("z05").setValue(sbalance);//amount
                }
            }
        ...
        //day money
        dbs.child("d").child(dayformat.format(csummary.getTime())).child("e-"+s).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.hasChild("z04")) {
                    ...
                    //dbs.child("d").child(dayformat.format(csummary.getTime())).child("e-"+s).child("z03").setValue("ex");
                    dbs.child("d").child(dayformat.format(csummary.getTime())).child("e-"+s).child("z04").setValue(sName);
                    dbs.child("d").child(dayformat.format(csummary.getTime())).child("e-"+s).child("z05").setValue(sbalance);
                }
            }
