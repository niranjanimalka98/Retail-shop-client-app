...
public class MyAdapterCustomer extends RecyclerView.Adapter<MyViewHolderCustomer> implements Filterable {
    ...
    public void onBindViewHolder(final MyViewHolderCustomer holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if(models.get(position).getP22().equals("")) {
            holder.locbutton.setVisibility(View.INVISIBLE);
        }else{
            holder.locbutton.setVisibility(View.VISIBLE);
        }
        holder.locbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(models.get(position).getP22() != null) {
                    String url = "https://www.google.lk/maps/place/" + models.get(position).getP22();
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    c.startActivity(i);
                }else{
                    Toast.makeText(c, "No Location Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        holder.delbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbp = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("customers").child(models.get(position).getKey());
                //db.keepSynced(true);
                    ...
                    public void onDataChange(final DataSnapshot dataSnapshot) {
                        ...
                        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //update count
                                dut.getParent().child("Customer").child("count").addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {

                                        dut.getParent().child("Customer").child("count")
